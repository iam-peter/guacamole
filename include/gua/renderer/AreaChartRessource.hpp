...
#ifndef GUA_AREA_CHART_RESSOURCE_HPP
#define GUA_AREA_CHART_RESSOURCE_HPP
 ...
 */
class AreaChartRessource : public GeometryRessource {
 public:

  /**
   * Default constructor.
   *
   * Creates a new and empty AreaChart.
   */
  AreaChartRessource(
...
#endif  // GUA_AREA_CHART_RESSOURCE_HPP
