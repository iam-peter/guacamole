...
#ifndef GUA_LINE_CHART_RESSOURCE_HPP
#define GUA_LINE_CHART_RESSOURCE_HPP
 ...
 */
class LineChartRessource : public GeometryRessource {
 public:

  /**
   * Default constructor.
   *
   * Creates a new and empty LineChart.
   */
  LineChartRessource(
...
#endif  // GUA_LINE_CHART_RESSOURCE_HPP
