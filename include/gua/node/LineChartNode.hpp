...
#ifndef GUA_LINE_CHART_NODE_HPP
#define GUA_LINE_CHART_NODE_HPP
 ...
 */
class GUA_DLL LineChartNode : public GeometryNode {
 public:  // member

  LineChartNode(std::string const& name,
