...
#ifndef GUA_POLY_LINE_NODE_HPP
#define GUA_POLY_LINE_NODE_HPP
 ...
 */
class GUA_DLL PolyLineNode : public GeometryNode {
 public:  // member

  PolyLineNode(std::string const& name,
