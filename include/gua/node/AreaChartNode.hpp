...
#ifndef GUA_AREA_CHART_NODE_HPP
#define GUA_AREA_CHART_NODE_HPP
 ...
 */
class GUA_DLL AreaChartNode : public GeometryNode {
 public:  // member

  AreaChartNode(std::string const& name,
