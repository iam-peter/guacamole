...
namespace gua {
  ...
  void GraphNode::ray_test_impl(RayNode const& ray, PickResult::Options options,
  ...
  std::shared_ptr<Node> GraphNode::copy() const {
    auto result(std::make_shared<GraphNode>(get_name(), filename_, material_, get_transform()));
