...
namespace gua {
  ...
  void ConeTreeUberShader::create(std::set<std::string> const& material_names)
  {
  ...
  /*virtual*/ GeometryUberShader::stage_mask const ConeTreeUberShader::get_stage_mask() const
  {
  ...
  /*virtual*/ void  ConeTreeUberShader::preframe(RenderContext const& context) const
  {
    throw std::runtime_error("ConeTreeUberShader::preframe(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void  ConeTreeUberShader::predraw(RenderContext const& ctx,
  ...
  {
    throw std::runtime_error("ConeTreeUberShader::predraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void ConeTreeUberShader::draw(RenderContext const& ctx,
                                           std::string const& filename,
                                           std::string const& material_name,
                                           scm::math::mat4 const& model_matrix,
                                           scm::math::mat4 const& normal_matrix,
                                           ...
                                           std::size_t /*viewid*/) const
  {
    auto geometry = std::static_pointer_cast<ConeTreeRessource>(GeometryDatabase::instance()->lookup(filename));
  ...
  /*virtual*/ void ConeTreeUberShader::postdraw(RenderContext const& ctx,
    std::string const& filename,
    std::string const& material_name,
    scm::math::mat4 const& model_matrix,
    scm::math::mat4 const& normal_matrix,
    ...
    std::size_t /*viewid*/) const
  {
    throw std::runtime_error("ConeTreeUberShader::postdraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void ConeTreeUberShader::postframe(RenderContext const& context) const
  {
    throw std::runtime_error("ConeTreeUberShader::postframe(): not implemented");
  }
