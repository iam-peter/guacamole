...
GraphRessource::GraphRessource(aiMesh* mesh, std::shared_ptr<Assimp::Importer> const& importer,
           bool build_kd_tree)
    : vertices_(),
      indices_(),
      vertex_array_(),
...
void GraphRessource::ray_test(Ray const& ray, PickResult::Options options,
...
unsigned int GraphRessource::num_vertices() const { return mesh_->mNumVertices; }

////////////////////////////////////////////////////////////////////////////////

unsigned int GraphRessource::num_faces() const { return mesh_->mNumFaces; }

////////////////////////////////////////////////////////////////////////////////

scm::math::vec3 GraphRessource::get_vertex(unsigned int i) const {
...
std::vector<unsigned int> GraphRessource::get_face(unsigned int i) const {
...
/*virtual*/ std::shared_ptr<GeometryUberShader> GraphRessource::create_ubershader() const {
