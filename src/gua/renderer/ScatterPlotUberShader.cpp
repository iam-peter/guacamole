...
namespace gua {
  ...
  void ScatterPlotUberShader::create(std::set<std::string> const& material_names)
  {
  ...
  /*virtual*/ GeometryUberShader::stage_mask const ScatterPlotUberShader::get_stage_mask() const
  {
  ...
  /*virtual*/ void  ScatterPlotUberShader::preframe(RenderContext const& context) const
  {
    throw std::runtime_error("ScatterPlotUberShader::preframe(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void  ScatterPlotUberShader::predraw(RenderContext const& ctx,
  ...
  {
    throw std::runtime_error("ScatterPlotUberShader::predraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void ScatterPlotUberShader::draw(RenderContext const& ctx,
                                           std::string const& filename,
                                           std::string const& material_name,
                                           scm::math::mat4 const& model_matrix,
                                           scm::math::mat4 const& normal_matrix,
  ...
  /*virtual*/ void ScatterPlotUberShader::postdraw(RenderContext const& ctx,
    std::string const& filename,
    std::string const& material_name,
    scm::math::mat4 const& model_matrix,
    scm::math::mat4 const& normal_matrix,
    ...
    std::size_t /*viewid*/) const
  {
    throw std::runtime_error("ScatterPlotUberShader::postdraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void ScatterPlotUberShader::postframe(RenderContext const& context) const
  {
    throw std::runtime_error("ScatterPlotUberShader::postframe(): not implemented");
  }
