...
namespace gua {
  ...
  void GraphUberShader::create(std::set<std::string> const& material_names)
  {
    ...
    std::string vertex_shader(
      Resources::lookup_shader(Resources::shaders_uber_shaders_gbuffer_graph_graph_vert)
      );
    ...
    std::string fragment_shader(
      Resources::lookup_shader(Resources::shaders_uber_shaders_gbuffer_graph_graph_frag)
      );
  ...
  /*virtual*/ GeometryUberShader::stage_mask const GraphUberShader::get_stage_mask() const
  {
  ...
  /*virtual*/ void  GraphUberShader::preframe(RenderContext const& context) const
  {
    throw std::runtime_error("GraphUberShader::preframe(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void  GraphUberShader::predraw(RenderContext const& ctx,
  ...
  {
    throw std::runtime_error("GraphUberShader::predraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void GraphUberShader::draw(RenderContext const& ctx,
                                           std::string const& filename,
                                           std::string const& material_name,
                                           scm::math::mat4 const& model_matrix,
                                           scm::math::mat4 const& normal_matrix,
                                           ...
                                           std::size_t /*viewid*/) const
  {
    auto geometry = std::static_pointer_cast<GraphRessource>(GeometryDatabase::instance()->lookup(filename));
  ...
  /*virtual*/ void GraphUberShader::postdraw(RenderContext const& ctx,
    std::string const& filename,
    std::string const& material_name,
    scm::math::mat4 const& model_matrix,
    scm::math::mat4 const& normal_matrix,
    ...
    std::size_t /*viewid*/) const
  {
    throw std::runtime_error("GraphUberShader::postdraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void GraphUberShader::postframe(RenderContext const& context) const
  {
    throw std::runtime_error("GraphUberShader::postframe(): not implemented");
  }
