...
namespace gua {
  ...
  void PolyLineUberShader::create(std::set<std::string> const& material_names)
  {
  ...
  /*virtual*/ GeometryUberShader::stage_mask PolyLineUberShader::get_stage_mask() const
  {
  ...
  /*virtual*/ void  PolyLineUberShader::preframe(RenderContext const& context) const
  {
    throw std::runtime_error("PolyLineUberShader::preframe(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void  PolyLineUberShader::predraw(RenderContext const& ctx,
  ...
  {
    throw std::runtime_error("PolyLineUberShader::predraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void PolyLineUberShader::draw(RenderContext const& ctx,
                                           std::string const& filename,
                                           std::string const& material_name,
                                           scm::math::mat4 const& model_matrix,
                                           scm::math::mat4 const& normal_matrix,
                                           ...
                                           View const& view) const
  {
    auto geometry = std::static_pointer_cast<PolyLineRessource>(GeometryDatabase::instance()->lookup(filename));
  ...
  /*virtual*/ void PolyLineUberShader::postdraw(RenderContext const& ctx,
    std::string const& filename,
    std::string const& material_name,
    scm::math::mat4 const& model_matrix,
    scm::math::mat4 const& normal_matrix,
    ...
    View const& view) const
  {
    throw std::runtime_error("PolyLineUberShader::postdraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void PolyLineUberShader::postframe(RenderContext const& context) const
  {
    throw std::runtime_error("PolyLineUberShader::postframe(): not implemented");
  }
