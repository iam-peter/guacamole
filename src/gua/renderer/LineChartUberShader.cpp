...
// class header
#include <gua/renderer/LineChartUberShader.hpp>
...
namespace gua {
  ...
  void LineChartUberShader::create(std::set<std::string> const& material_names)
  {
  ...
  /*virtual*/ GeometryUberShader::stage_mask LineChartUberShader::get_stage_mask() const
  {
  ...
  /*virtual*/ void  LineChartUberShader::preframe(RenderContext const& context) const
  {
    throw std::runtime_error("LineChartUberShader::preframe(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void  LineChartUberShader::predraw(RenderContext const& ctx,
  ...
  {
    throw std::runtime_error("LineChartUberShader::predraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void LineChartUberShader::draw(RenderContext const& ctx,
                                           std::string const& filename,
                                           std::string const& material_name,
                                           scm::math::mat4 const& model_matrix,
                                           scm::math::mat4 const& normal_matrix,
                                           ...
                                           View const& view) const
  {
    auto geometry = std::static_pointer_cast<LineChartRessource>(GeometryDatabase::instance()->lookup(filename));
  ...
  /*virtual*/ void LineChartUberShader::postdraw(RenderContext const& ctx,
    std::string const& filename,
    std::string const& material_name,
    scm::math::mat4 const& model_matrix,
    scm::math::mat4 const& normal_matrix,
    ...
    View const& view) const
  {
    throw std::runtime_error("LineChartUberShader::postdraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void LineChartUberShader::postframe(RenderContext const& context) const
  {
    throw std::runtime_error("LineChartUberShader::postframe(): not implemented");
  }
