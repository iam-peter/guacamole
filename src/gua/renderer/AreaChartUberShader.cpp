...
// class header
#include <gua/renderer/AreaChartUberShader.hpp>
...
namespace gua {
  ...
  void AreaChartUberShader::create(std::set<std::string> const& material_names)
  {
  ...
  /*virtual*/ GeometryUberShader::stage_mask AreaChartUberShader::get_stage_mask() const
  {
  ...
  /*virtual*/ void  AreaChartUberShader::preframe(RenderContext const& context) const
  {
    throw std::runtime_error("AreaChartUberShader::preframe(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void  AreaChartUberShader::predraw(RenderContext const& ctx,
  ...
  {
    throw std::runtime_error("AreaChartUberShader::predraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void AreaChartUberShader::draw(RenderContext const& ctx,
                                           std::string const& filename,
                                           std::string const& material_name,
                                           scm::math::mat4 const& model_matrix,
                                           scm::math::mat4 const& normal_matrix,
                                           ...
                                           View const& view) const
  {
    auto geometry = std::static_pointer_cast<ScatterPlotRessource>(GeometryDatabase::instance()->lookup(filename));
  ...
  /*virtual*/ void AreaChartUberShader::postdraw(RenderContext const& ctx,
    std::string const& filename,
    std::string const& material_name,
    scm::math::mat4 const& model_matrix,
    scm::math::mat4 const& normal_matrix,
    ...
    View const& view) const
  {
    throw std::runtime_error("AreaChartUberShader::postdraw(): not implemented");
  }

  ////////////////////////////////////////////////////////////////////////////////

  /*virtual*/ void AreaChartUberShader::postframe(RenderContext const& context) const
  {
    throw std::runtime_error("AreaChartUberShader::postframe(): not implemented");
  }
