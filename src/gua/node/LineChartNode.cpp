...
namespace node {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  LineChartNode::LineChartNode(std::string const& name,
  ...
  void LineChartNode::ray_test_impl(RayNode const& ray, PickResult::Options options,
  ...
  void LineChartNode::update_cache() {
...
*/
  ...
  std::shared_ptr<Node> LineChartNode::copy() const {
    return std::make_shared<LineChartNode>(get_name(), filename_, material_, get_transform());
  }
