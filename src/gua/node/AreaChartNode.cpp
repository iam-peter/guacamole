...
namespace node {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  AreaChartNode::AreaChartNode(std::string const& name,
  ...
  void AreaChartNode::update_cache() {
...
*/
  ...
  std::shared_ptr<Node> AreaChartNode::copy() const {
    return std::make_shared<AreaChartNode>(get_name(), filename_, material_, get_transform());
  }
