...
namespace node {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  PolyLineNode::PolyLineNode(std::string const& name,
  ...
  void PolyLineNode::ray_test_impl(RayNode const& ray, PickResult::Options options,
  ...
  void PolyLineNode::update_cache() {
...
*/
  ...
  std::shared_ptr<Node> PolyLineNode::copy() const {
    return std::make_shared<PolyLineNode>(get_name(), filename_, material_, get_transform());
  }
